...
class LightSystem:
    ...
    def __init__(self, ambient = [ 0.2, 0.2, 0.2, 1.0 ], *ls):
        vs_path = os.path.join(current_dir, 'resources/shaders/fogLight.vs')
        fs_path = os.path.join(current_dir, 'resources/shaders/fogLight.fs')
        self.shader = rl.LoadShader(vs_path.encode('utf-8'), fs_path.encode('utf-8'))
