...
from tests.raylib.fustum_test.v2.rlmath import *
...
char = os.path.join(current_dir, 'resources/test.png')
texture = rl.LoadTexture(char.encode('utf-8'))
